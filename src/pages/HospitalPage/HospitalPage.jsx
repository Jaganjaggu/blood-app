...
import HospitalDashboard from '../../components/HospitalComponents/HospitalDashboard';
                    ...
                    <List>
                        <ListItem disablePadding sx={{ display: 'block' }}>
                            ...
                            >
                                ...
                                >
                                    <i class="ri-contrast-drop-2-line" style={{ fontSize: '20px' }}></i>
                                </ListItemIcon>
                                <ListItemText primary="Donations" sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding sx={{ display: 'block' }}>
                            <ListItemButton
                            ...
                            >
                                ...
                                >
                                    <i class="ri-add-circle-fill" style={{ fontSize: '20px' }}></i>
                                </ListItemIcon>
